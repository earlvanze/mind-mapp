...
- Search (Cmd/Ctrl+K) with focus+center on selection, ID + path matching, ranked results, path/context metadata, highlighted matches, quoted/negated query terms, Tab/Page/Home-End navigation hints, and accurate match counts
