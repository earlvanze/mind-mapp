...
- Mini-map navigator (Shift+M toggle; click node to focus + center, click background to recenter, drag viewport box to pan, Arrow/Shift+Arrow pan + PageUp/PageDown vertical large pan + Shift+PageUp/PageDown horizontal large pan + Home/End edge-jump when mini-map is focused) with live viewport indicator
- Sample map loader
