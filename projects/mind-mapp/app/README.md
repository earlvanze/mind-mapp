...
- Multi-select (Cmd/Ctrl+click / Cmd/Ctrl+A / Alt+I invert / Alt+S siblings / Alt+C children / Alt+L leaves / Alt+U ancestors / Alt+T top-level / Alt+X clear extras / Alt+B subtree / Alt+P parent) + duplicate (Cmd/Ctrl+D, subtree-aware) + group drag + keyboard nudge (Alt+Arrow)
