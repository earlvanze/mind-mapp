...
- Pan/zoom + fit-to-view + fit-selection + fit-focused-subtree + keyboard +/- zoom + 0 reset shortcut + toolbar zoom indicator + root-focus/backtrack shortcuts + grid/mini-map toggles + reset view (mouse + touch, state-synced)
