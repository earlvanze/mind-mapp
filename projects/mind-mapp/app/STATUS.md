...
- Pan/zoom + fit-to-view + fit-selection + fit-focused-subtree + keyboard +/- zoom + 0 reset shortcut + toolbar zoom indicator + focus/selection/subtree/root centering + parent/child/sibling/root/backtrack focus shortcuts + grid/mini-map toggles + reset view (mouse + touch, state-synced)
