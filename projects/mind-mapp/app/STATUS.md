...
- Mini-map navigator (focus + center + background recenter + viewport drag pan + focused mini-map Arrow/Shift+Arrow panning + PageUp/PageDown vertical large-step panning + Shift+PageUp/PageDown horizontal large-step panning + Home/End edge-jumps) with live viewport indicator (event-synced)
